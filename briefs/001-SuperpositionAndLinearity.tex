...
\begin{abstract}
	UPDATED: We show why a direction in physical space is represented by a vector for the form $\cos \varphi \sin \theta e_x + \sin \varphi \sin \theta e_y + \cos \theta e_z$ while the state vector for a qubit, which also corresponds to a direction in physical space, is of the form $\cos \frac{\theta}{2} e^{-\imath \frac{\varphi}{2}} | z^+ \> + \sin \frac{\theta}{2} e^{\imath \frac{\varphi}{2}} | z^+ \>$.
\end{abstract}
